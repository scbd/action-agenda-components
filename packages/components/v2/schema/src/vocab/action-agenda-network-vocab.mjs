export default {
  '@id'     : 'https://cdn.cbd.int/@action-agenda/schema/dist/vocab/action-agenda-network-vocab.mjs',
  '@context': {
    '@version' : 0.1,
    '@language': 'en',
    aan        : 'https://cdn.cbd.int/@action-agenda/schema/dist/vocab/action-agenda-network-vocab.mjs',
