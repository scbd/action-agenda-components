...
import FieldErrorMessage  from './controls/FieldErrorMessage.vue'
...
function cleanForm(value){
  ...
  if(form && form.partners && form.partners.length)
    form.partners = form.partners.splice(0, form.partners.length-1)
  if(form && form.actionDetails && form.actionDetails.progressMeasured && isEmpty(form.actionDetails.progressMeasured))
    delete(form.actionDetails.progressMeasured)
