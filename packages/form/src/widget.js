...
const dependencies      = { all       : [ VUE, VUE_I18N, SCBD_SSO_AUTH ],
                            vuePlugins: [ VUE_I18N, SCBD_SSO_AUTH,
                              { name:'VeeValidate', noModule: true, url: 'https://cdn.cbd.int/vee-validate@2.2.15/dist/vee-validate.min.js', options: { locale, dictionary, fieldsBagName: 'veeFields', fastExit: false } }
                            ],
                            css       : [ 
