...
const  browserEsmPackages = {
  '@action-agenda/icons'               : `${cdnUrl}/@action-agenda/icons@1.0.4/dist/browser/index.min.js`,
  '@action-agenda/cached-apis'         : `${cdnUrl}/@action-agenda/cached-apis@1.0.12/dist/browser/index.min.js`,
  ...
  '@houlagins/self-embedding-component': `${cdnUrl}/@houlagins/self-embedding-component@1.0.17/dist/browser/index.min.js`
}
