...
const  browserEsmPackages = {
  ...
  '@action-agenda/cached-apis'         : `${cdnUrl}/@action-agenda/cached-apis@~1.0.1/dist/browser/index.min.js`,
  ...
  '@houlagins/self-embedding-component': `${cdnUrl}/@houlagins/self-embedding-component@~1.0.3/dist/browser/index.min.js`,
